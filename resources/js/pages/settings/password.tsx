...
const breadcrumbs: BreadcrumbItem[] = [
    {
        title: __('admin.password_settings'),
        href: edit().url,
    },
];
...
export default function Password() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={__('admin.password_settings')} />

            <SettingsLayout>
                <div className="space-y-6">
                    <HeadingSmall
                        title={__('admin.update_password')}
                        description={__('admin.password_security_note')}
                    />
